(function () {
    ...
    class BsAlertElement extends HTMLElement {
        static get observedAttributes() {return ['type', 'button']; } 	// Attributes to monitor
      ...
      //  adoptedCallback(oldDocument, newDocument) {}			// Called when the element is adopted to another document
    ...
    window.addEventListener('WebComponentsReady', function () {
        customElements.define('bs4-alert', BsAlertElement);		// Define the new element
    });
})();